...
import 'agendar_electrcista_model.dart';
export 'agendar_electrcista_model.dart';

class AgendarElectrcistaWidget extends StatefulWidget {
  const AgendarElectrcistaWidget({super.key});

  static String routeName = 'AgendarElectrcista';
  static String routePath = '/agendarElectrcista';

  @override
  State<AgendarElectrcistaWidget> createState() =>
      _AgendarElectrcistaWidgetState();
}

class _AgendarElectrcistaWidgetState extends State<AgendarElectrcistaWidget> {
  late AgendarElectrcistaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AgendarElectrcistaModel());
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              context.pushNamed(MenuElectricoWidget.routeName);
            },
          ),
          title: Text(
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  FFButtonWidget(
                    onPressed: () async {
                      await AgendaElectricoRecord.collection
                          .doc()
                          .set(createAgendaElectricoRecordData(
                            tipoServicio: _model.tipoValue,
                            descripcion: _model.descripcionTextController.text,
                            nombre: _model.nombreTextController.text,
                            contacto: _model.telefonoTextController.text,
