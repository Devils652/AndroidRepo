...
import 'agendar_fontaneria_model.dart';
export 'agendar_fontaneria_model.dart';

class AgendarFontaneriaWidget extends StatefulWidget {
  const AgendarFontaneriaWidget({super.key});

  static String routeName = 'AgendarFontaneria';
  static String routePath = '/agendarFontaneria';

  @override
  State<AgendarFontaneriaWidget> createState() =>
      _AgendarFontaneriaWidgetState();
}

class _AgendarFontaneriaWidgetState extends State<AgendarFontaneriaWidget> {
  late AgendarFontaneriaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AgendarFontaneriaModel());
    ...
    _model.adicionalTextController ??= TextEditingController();
    _model.adicionalFocusNode ??= FocusNode();
  }
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          backgroundColor: Color(0xFF1A5F9C),
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              context.pushNamed(MenuFontaneriaWidget.routeName);
            },
          ),
          title: Text(
            'Agendar Fontaneria',
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          FlutterFlowDropDown<String>(
                            controller: _model.tipoProblemaValueController ??=
                              ...
                              child: TextFormField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  contentPadding:
                                      EdgeInsetsDirectional.fromSTEB(
                                          16.0, 12.0, 16.0, 12.0),
                                  suffixIcon: _model.contactoTextController!
                                          .text.isNotEmpty
                                      ? InkWell(
                                          onTap: () async {
                                            _model.contactoTextController
                            ...
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                contentPadding: EdgeInsetsDirectional.fromSTEB(
                                    16.0, 12.0, 16.0, 12.0),
                                suffixIcon: _model.direccionTextController!.text
                                        .isNotEmpty
                                    ? InkWell(
                                        onTap: () async {
                                          _model.direccionTextController
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Container(
                            width: double.infinity,
                            child: TextFormField(
                              controller: _model.adicionalTextController,
                              focusNode: _model.adicionalFocusNode,
                              onChanged: (_) => EasyDebounce.debounce(
                                '_model.adicionalTextController',
                                Duration(milliseconds: 2000),
                                () => safeSetState(() {}),
                              ),
                              autofocus: false,
                              ...
                              decoration: InputDecoration(
                                ...
                                contentPadding: EdgeInsetsDirectional.fromSTEB(
                                    16.0, 12.0, 16.0, 12.0),
                                suffixIcon: _model.adicionalTextController!.text
                                        .isNotEmpty
                                    ? InkWell(
                                        onTap: () async {
                                          _model.adicionalTextController
                              ...
                              minLines: 3,
                              cursorColor: Color(0xFF1A5F9C),
                              validator: _model.adicionalTextControllerValidator
                                  .asValidator(context),
                            ),
                          ),
                        ],
                  ...
                  FFButtonWidget(
                    onPressed: () async {
                      await AgendaFontaRecord.collection
                          .doc()
                          .set(createAgendaFontaRecordData(
                            problema: _model.tipoProblemaValue,
                            descripcion: _model.descripcionTextController.text,
                            nombre: _model.nombreTextController.text,
                            numero: _model.contactoTextController.text,
                            direccion: _model.direccionTextController.text,
                            fecha: _model.calendarioSelectedDay?.start,
                            horario: _model.horarioValue,
                            adicional: _model.adicionalTextController.text,
                          ));
                      safeSetState(() {
                        _model.adicionalTextController?.clear();
                        _model.direccionTextController?.clear();
                        _model.contactoTextController?.clear();
